 ...
 * @Date: 2023-07-11 17:19:43
 * @LastEditors: zigfried 3572931733@qq.com
 * @LastEditTime: 2023-07-12 10:26:47
 * @FilePath: /localizationProject/src/lidar_localization/src/apps/test_frame_node.cpp
 * @Description: 
 * 
...
int main(int argc, char** argv) {
    ...
    FLAGS_log_dir = WORK_SPACE_PATH + "/logs";
    ...
    std::shared_ptr<OdometryPublisher> odom_pub_ptr = std::make_shared<OdometryPublisher>(nh, "lidar_odom", "map", "base_link", 100);
