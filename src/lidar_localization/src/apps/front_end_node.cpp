 ...
 * @LastEditTime: 2023-07-13 15:21:48
...
int main(int argc, char **argv) {
    ...
    std::shared_ptr<CloudPublisher> local_map_pub_ptr = std::make_shared<CloudPublisher>(nh, "local_map", "map", 100);
    std::shared_ptr<CloudPublisher> global_map_pub_ptr = std::make_shared<CloudPublisher>(nh, "global_map", "map", 100);
